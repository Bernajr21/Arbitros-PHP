...
/*
$mesBefore = $mes - 01;
$fecha3 = $year . '-' . $mesBefore . '-01';
$fecha4 = $year . '-' . $mes . '-01';
$consulta2 = 'SELECT ROUND(SUM(a.tab02_importe),2) FROM `tab02_partido` a WHERE a.tab02_fecha >= \'' . $fecha3 . '\' AND a.tab02_fecha <= \'' . $fecha4 . '\' AND a.tab02_pagado = 1';
$res2 = mysqli_query($conn, $consulta2);
$row2 = mysqli_fetch_row($res2);
$sum2 = $row2[0];

$porcentaje = $sum * 100 / $sum2;
*/
function obtenerNombre($conn)
{

    $usuario = "SELECT a.tab01_nombre, a.tab01_first_apellido FROM `tab01_arbitro` a WHERE a.tab01_id_arbitro = 1";

    $res = mysqli_query($conn, $usuario);
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <img src="assets/css/img/logofed_blanco.png" alt="" class="sidenav-img">
                </div>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.html">
                    ...
                    <span><?php echo obtenerNombre($conn) ?></span></a>
            </li>
